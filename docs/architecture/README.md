...
We isolate the components and modules code, tests and docs. But we place the design at `src/scss`, resources at distribution folder `dist`, general JS at `src/core` and global styles at `src/scss/core`.
