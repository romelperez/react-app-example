...
We isolate the components and modules code (design and functional), tests and docs. But we store resources at distribution folder `dist`, general JS at `src/core` and global styles at `src/scss/core`.
